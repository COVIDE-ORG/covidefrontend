...
const Header = props => {
  ...
  const routes = [
    ...
    { name: 'Database search', link: '/database', activeIndex: 1 },
    { name: 'Volunteers', link: '/volunteers', activeIndex: 2 },
    { name: 'Ask for help', link: '/help', activeIndex: 3 }
  ];
  ...
  }, [value, selectedIndex, routes, props]);
    ...
    <>
      ...
      >
        ...
        <List disablePadding>
          ...
          <ListItem
            classes={{
              root: classes.drawerItemTextlinks,
