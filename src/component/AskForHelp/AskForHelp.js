...
export default function AskForHelp() {
  ...
  const handleSubmit = (e) => {
    ...
    .then(res => {
      ...
      if(res.status === 200){
        alert("Your Query Has been Submitted Successfully. We will contact you soon");
        setName("");
        setContact("");
        setQuery("");
      }
  ...
  return (
    <div style={{ backgroundColor: "#f4eee8", margin: 0, top: 0,marginTop: "-63px",marginBottom: "20px" }}>
      <Container
        component="main"
        maxWidth="md"
