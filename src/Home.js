...
const closeModal = () => {
  ...
  return (
   ...
   <Helmet>
        ...
        <meta
      name="description"
      content="Covid Resources. List of Oxygen, Ambulance Services, Plasma, Hospital Beds, Remdesivir, Tocilizumab, FabiFlu etc in India. COVID-19 India Help- View all resources, ranging from Pan-India to State-wise COVID-19 Resource Lists."
    />
    </Helmet>
      <Header/>
      <Card/>
